...
export default function Home() {
  ...
  const downloadQR = async () => {
    ...
    try {
      ...
      const qrTargetUrl = `${window.location.origin}/map`;
      ...
      >
        ...
        <div className="relative p-7 space-y-6 text-center">
          ...
          <div className="space-y-1.5">
            ...
            <h2 className="text-lg font-black text-white">Event Navigator</h2>
          ...
          <div className="space-y-1">
            <p className="text-sm font-bold text-white">📍 Event Main QR Code</p>
