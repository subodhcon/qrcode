...
export default function Home() {
  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center py-10 px-4 animate-fade-slide-up bg-slate-50">

      {/* ── Page Hero ── */}
      <div className="text-center mb-8 space-y-2">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-500/30 bg-emerald-50 text-emerald-700 text-[11px] font-bold uppercase tracking-widest mb-3">
        ...
        <p className="text-sm text-slate-500 max-w-xs mx-auto leading-relaxed">
          Print and deploy this unique QR placard sign at the event for visitor navigation.
        </p>
      </div>
