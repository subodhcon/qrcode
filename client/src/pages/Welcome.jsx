  ...
  return (
    <div className="relative min-h-screen w-full bg-slate-950 text-white flex flex-col items-center justify-between overflow-x-hidden font-sans selection:bg-emerald-500 selection:text-white">
      ...
      <div className="relative z-10 w-full max-w-md min-h-screen px-4 py-4 flex flex-col justify-between space-y-5">
        ...
        {/* ── Emergency Helpline Banner (Bottom Action) ── */}
        <section className="pt-1">
          <div
            onClick={() => setSosActive(true)}
            className="w-full p-4 rounded-2xl bg-gradient-to-r from-red-50 to-orange-50 text-slate-900 border border-red-200 shadow-2xl flex items-center justify-between cursor-pointer hover:bg-white transition-all active:scale-[0.99] group"
          >
            <div className="text-left space-y-0.5">
              <h4 className="text-base font-black text-red-600 tracking-tight leading-tight">
                {t('emergencyHelpline') || "Emergency Helpline"}
              </h4>
            ...
            <div className="w-12 h-12 rounded-full bg-red-500 flex items-center justify-center text-white shadow-lg shadow-red-500/40 group-hover:scale-105 transition-transform shrink-0">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
